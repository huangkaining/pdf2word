...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.statuelabel = QtWidgets.QLabel(self.centralwidget)
        self.statuelabel.setGeometry(QtCore.QRect(10, 440, 281, 101))
        font = QtGui.QFont()
        font.setPointSize(27)
        self.statuelabel.setFont(font)
        self.statuelabel.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.statuelabel.setAlignment(QtCore.Qt.AlignCenter)
        self.statuelabel.setObjectName("statuelabel")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.statuelabel.setText(_translate("MainWindow", "未开始"))
